...
@Entity("202308" ,{schema:"planetb_ventas" } )
export  class 202308 {
...
@Column("decimal",{ name:"収入金額",nullable:true,precision:9,scale:3 })
:string | null;

@Column("decimal",{ name:"支出金額",nullable:true,precision:9,scale:3 })
:string | null;
