...
@Entity("202311_banco" ,{schema:"planetb_ventas" } )
export  class 202311Banco {
...
@Column("varchar",{ name:"預入金額",nullable:true,length:6 })
:string | null;

@Column("varchar",{ name:"引出金額",nullable:true,length:6 })
:string | null;

@Column("int",{ name:"残高",nullable:true })
:number | null;

@Column("varchar",{ name:"摘要",nullable:true,length:26 })
:string | null;
